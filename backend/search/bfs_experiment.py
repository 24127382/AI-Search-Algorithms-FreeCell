"""Breadth-First Search with detailed experimental logging.

This module provides a BFS implementation optimized for controlled experiments:
...
class BFSExperiment:
    """BFS with experimental stopping conditions and detailed logging."""
    ...
    def __init__(
        ...
        """Initialize BFS for experiment.
        
        Args:
            initial_state: Starting game state.
            max_frontier_size: Stop when frontier exceeds this size.
    ...
    def search(self) -> Optional[List[Move]]:
        """Execute BFS with early stopping and logging.
        ...
        - Frontier size exceeding max_frontier_size
        ...
        while frontier:
            ...
            if current_state.is_goal:
                ...
                elapsed = time.time() - start_time
                self._log_step(step_id, elapsed, len(frontier), expanded_count, current_hash, parents)
                return path
        ...
        elapsed = time.time() - start_time
        self._log_step(step_id, elapsed, len(frontier), expanded_count, 0, parents)
        return None
    ...
    def save_logs(self, filepath: str):
        ...
        print(f"BFS logs saved to {filepath}")
