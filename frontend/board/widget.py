...
from frontend.shared.qt import QWidget, Signal
...
class BoardWidget(
    ...
    def _build_initial_state(self) -> State:
        ...
        deal_number = (
            ...
            if self.requested_deal_number is not None
            else random_deal_number()
        )
        ...
        return State.from_lists(
            tableau=tableau, freecells=[None] * 4, foundations=[[] for _ in range(4)]
        )
