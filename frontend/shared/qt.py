...
try:
    from PySide6.QtCore import Qt, Signal, QMimeData, QPropertyAnimation, QEasingCurve, QTimer, QThread, QPoint
    ...
    from PyQt6.QtCore import Qt, QMimeData, QPropertyAnimation, QEasingCurve, QTimer, QThread, QPoint, pyqtSignal as Signal
